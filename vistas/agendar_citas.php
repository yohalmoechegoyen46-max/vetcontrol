...
<body>
    <div class="contenido">
        <div class="formulario">
            ...
            <p class="text-muted">Completa el formulario para agendar una cita</p>
            <?php if (isset($_GET['msg']) && $_GET['msg'] === 'guardado'): ?>
                <div class="alert alert-success">Cita guardada correctamente.</div>
            <?php elseif (isset($_GET['msg']) && $_GET['msg'] === 'error'): ?>
                <div class="alert alert-danger">Error al guardar: <?php echo htmlspecialchars($_GET['err'] ?? ''); ?></div>
            <?php endif; ?>
